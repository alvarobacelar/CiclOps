...
if ($_SESSION["nivel"] == "admin") {
    ...
    if (isset($idUser) && !empty($nomeUser) && !empty($pathTomcat) && !empty($servidorUser) && !empty($idUser)) {
        ...
        $editaServidor->setCamposBanco("id_servidor='$servidorUser',nome_usuarios_servidor='$nomeUser',path_usuarios_servidor='$pathTomcat',status_usuario_servidor='$status'");
