...
if ($estaLogado == "SIM") {
  ...
  if (isset($_POST["reverterSistema"])) {
    ...
    */
    ...
    $reiniciaTomcatServico = "systemctl restart " . $filAr->nome_servico;

    /*
    * EXECUÇÃO DOS COMANDOS ACIMA SETADOS
    */
    if ($filAr->startup == "servico"){
      ...
      myshellexec( $mvRever );
      echo "<strong>Reiniciando o serviço do tomcat </strong><br>";
      displaysecinfo("3 - Iniciando o tomcat <br> ", shell_exec($reiniciaTomcatServico));
    } else {
