<div class="panel panel-primary">
    ...
    <div class="panel-body">
        ...
        {$erroCadastro} 
        <form action="includes/controllers/cadastraServidorControl.php" method="post" name="cadastrar" class="form-horizontal" role="form" onSubmit="return verificaSenha()">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="inputServidor">Nome do Servidor</label>
                <div class="col-sm-6">
            ...
            <div class="row form-group">
                <label class="col-sm-2 control-label" for="inputIP">IP do servidor</label>
                <div class="col-sm-3">
            ...
            <div class="form-group ">
                <label class="col-sm-2 control-label" for="selectGrupo">Grupo de servidores</label>
                <div class="col-sm-3">
            ...
            <div class="row form-group">
                <label class="col-sm-2 control-label" for="textObsServer"> Observações</label>
                <div class="col-sm-6">
